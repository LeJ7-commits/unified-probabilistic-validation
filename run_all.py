...
STAGES = [
    {
        ...
        "scripts": [
            ...
            "scripts/build_simulation_extended_derived.py",   # ← add this
        ],
    ...
    {
        "id":       7,
        "name":     "Extended simulation — electricity price (run_011)",
        "scripts":  ["experiments/run_011_sim_elec_price.py"],
        "optional": False,
        "description": "Class 1 positive control — electricity price DGP (extended 5D simulation)",
    },
    {
        "id":       8,
        "name":     "Extended simulation — natural gas (run_012)",
        "scripts":  ["experiments/run_012_sim_nat_gas.py"],
        "optional": False,
        "description": "Class 1 positive control — natural gas DGP (extended 5D simulation)",
    },
    {
        "id":       9,
        "name":     "Extended simulation — carbon (run_013)",
        "scripts":  ["experiments/run_013_sim_carbon.py"],
        "optional": False,
        "description": "Class 1 positive control — carbon CO2 DGP (extended 5D simulation)",
    },
    {
        "id":      10,
    ...
    {
    "id":       11,
    "name":     "Extended simulation multivariate diagnostics (run_014)",
    "scripts":  ["experiments/run_014_multivariate_extended.py"],
    "optional": False,
    "description": "Joint breach correlation across 5 simulation commodity series",
    },
    {
        "id":      12,
