"""
experiments/run_013_sim_carbon.py
======================================
Probabilistic validation for the extended simulation — carbon (CO2) series.

Model class : Class 1 — Simulation (positive control, well-specified DGP)
Series      : carbon  (base=65 €/tCO2, σ=6, no intraday cycle)
n           : 365 as-of dates (h=1 evaluation)
Expected    : GREEN — realised values drawn from same DGP as simulation paths

Part of the five-dimensional extended simulation (carbon, nat_gas,
...
OUT_DIR  = REPO / "experiments" / f"run_013_sim_{SERIES}"


if __name__ == "__main__":
    print("=" * 60)
    print(f"  Simulation — {SERIES} (run_013)")
    print("=" * 60)
