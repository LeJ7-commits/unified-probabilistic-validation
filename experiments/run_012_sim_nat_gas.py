"""
experiments/run_012_sim_nat_gas.py
======================================
Probabilistic validation for the extended simulation — natural gas series.

Model class : Class 1 — Simulation (positive control, well-specified DGP)
Series      : nat_gas  (base=40 €/MWh, σ=8, moderate intraday amplitude)
n           : 365 as-of dates (h=1 evaluation)
Expected    : GREEN — realised values drawn from same DGP as simulation paths

Part of the five-dimensional extended simulation (nat_gas, nat_gas,
...
OUT_DIR  = REPO / "experiments" / f"run_012_sim_{SERIES}"


if __name__ == "__main__":
    print("=" * 60)
    print(f"  Simulation — {SERIES} (run_012)")
    print("=" * 60)
